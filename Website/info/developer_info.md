...
Applies to **both** twins (identical code; line numbers differ). Adds a `DECALS` section (`m_start_decals`, placed after `m_end_surf_shape`) for placing logos / stickers / brand art / tattoos on the material.
